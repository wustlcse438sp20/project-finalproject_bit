...
that they like it. 
    We also have short video sharing function, which will allow users to upload short videos shot by the 
camera or from local album to the blog. 
    We also add a social system to this app. For example, a user can add others as friends and chat privately 
with them. 
    We also allow users to modify personal information such as nickname and profile picture. 
...
* Is there anything that you did that you feel might be unclear? Explain it here.
    Only the master branch is our final project submission. The other branches are just for intra group communications.
